...
<div class="row">
    <div class="col-md-6">
        <div style="margin-left: 30px;margin-top: 20px;">
            ...
            <p>
                ...
                <span style="color: #357ebd;font-weight: bold;">eureka.client.serviceUrl.defaultZone=http://XXXXXXXXXXXXXXXXXX/eureka/</span>
            </p>
            <br>
            <h3>注意事项</h3>
            <div style="color:red;">
            ...
            <div style="margin-top: 20px;">
                P.S. 如在学习与使用过程中遇到困难，就来<a href="http://www.jeeit.com" target="_blank">JEEIT 社区</a>探讨交流。
            </div>
        </div>
    </div>
    <#--替换-->
    <div class="col-md-3">
        <div style="margin-left: 30px;margin-top: 20px;">
            <h3>参考资料</h3>
            <div>
                <li><a href="http://www.jeeit.com/Spring-Boot%E5%9F%BA%E7%A1%80%E6%95%99%E7%A8%8B/" target="_blank">Spring Boot基础教程</a></li>
                <li><a href="http://www.jeeit.com/Spring-Cloud%E5%9F%BA%E7%A1%80%E6%95%99%E7%A8%8B/" target="_blank">Spring Cloud基础教程</a></li>
            </div>
            <br>
            <h3>关注我</h3>
            <div>
                <li class="foot-li">
                    <a href="https://github.com/jeeit" target="_blank">Github</a>
                </li>
                <li class="foot-li">
                    <a href="http://git.oschina.net/jee-it" target="_blank">码云</a>
                </li>
                <li class="foot-li">
                    <a href="http://www.jianshu.com/u/jeeit" target="_blank">简书</a>
                </li>
                <li class="foot-li">
                    <a href="https://www.zhihu.com/people/jeeit" target="_blank">知乎</a>
                </li>
            </div>
    ...
    <div class="col-md-3">
        <div style="margin-left: 30px;margin-top: 20px;">
            <h3>ABOUT ME</h3>
            <img style="width: 200px;" src="/eureka/images/about-BY-gentle.jpg" />
            <br><br>
        </div>
    </div>
